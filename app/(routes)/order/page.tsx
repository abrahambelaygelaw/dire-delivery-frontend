...
export default function Page() {
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="w-full h-[320px] md:h-[720px] px-6 md:px-[120px] py-[183px] bg-[linear-gradient(to_right,_rgba(0,0,0,0.7),rgba(0,0,0,0)),url('/images/track-order-banner.jpg')] flex-col justify-center items-start gap-4 inline-flex overflow-hidden bg-cover bg-center bg-no-repeat md:bg-cover">
